...
#SBATCH --job-name="polyepo"

# ============ Environment Setup ============
source /path/to/miniconda3/bin/activate
conda activate /path/to/envs/polyepo/
cd /path/to/polyepo
...
TEST_DATASET_PATH="['/path/to/polyepo/data/aime25/test.parquet','/path/to/polyepo/data/beyondaime/test.parquet','/path/to/polyepo/data/minerva/test.parquet']"

# PolyEPO specific settings from your original script
ALGORITHM=polyepo
MODEL_PATH=Qwen/Qwen3-4B-Base
PROJECT_NAME=verl_polyepo
EXPERIMENT_NAME=polyepo
